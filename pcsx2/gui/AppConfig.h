...
#include <memory>
#include "Netplay\NetplaySettings.h"            //NetPlay Code Added-YungMoniCA1
#include "Netplay\ReplaySettings.h"            //NetPlay Code Added-YungMoniCA1
...
public:
	...
	NetplaySettings			Net;                 //NetPlay Code Added-YungMoniCA1
	ReplaySettings			Replay;             //NetPlay Code Added-YungMoniCA1
